...
import { handleFollowCount, handleFollowerCount, handleEditProfile } from "@/features/profile/handleprofile";
...
export default function ProfilePage() {
	...
	const {data:userData, error:error1,isLoading:isLoading1} = GetFetcher(`http://localhost:8080/user/${userid}`);
	const {data:tweetData,error:error2,  isLoading:isLoading2} = GetFetcher(`http://localhost:8080/tweet/${userid}`);
