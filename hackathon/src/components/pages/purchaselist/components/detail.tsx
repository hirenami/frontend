...
export default function Component() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      <h1 className="text-2xl font-bold mb-6">取引詳細</h1>

      <Alert className="bg-yellow-50 border-yellow-100 mb-6">
        <AlertDescription className="flex items-center gap-2">
          ✓ 取引が完了しました
          <p className="text-gray-600">このたびはメルカリのご利用ありがとうございました。</p>
        </AlertDescription>
      </Alert>
        ...
        <CardContent className="p-6">
          <div className="flex gap-4 mb-6">
            ...
            <div className="flex-1">
              <h2 className="text-lg font-semibold mb-2">{transaction.productName}</h2>
              <p className="text-2xl font-bold">¥{transaction.price.toLocaleString()}</p>
            </div>
          </div>
